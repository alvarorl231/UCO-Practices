/*
 * Programa de demostraci�n de signal()
 */
#include <signal.h>
#include <unistd.h>
#include <stdio.h>
...
/*
 * Programa principal.
 * Cambia el controlador para la se�al de ctrl-c y se mete en un bucle
 * infinito de espera
 */
...
void controlador (int pepito)
{
	...
	//signal (SIGINT, SIG_DFL); //Anula la recepci�n anterior de SIGINT por esta otra. Pruebe a comentar esta linea.
}
