...
int main(int argc, char **argv) {
    ...
    /* opterr=0; */
    while ( (c= getopt_long(argc, argv, "abed:c:f:l:", long_options, NULL)) != -1) {
        switch (c) {
        case 'a':
            // printf("Opción -a\n");
            aflag = true;
    ...
    printf("aflag = %d, bflag = %d, eflag = %d, cvalue = %s, dvalue = %s, fvalue = %s, lvalue = %s\n", aflag, bflag, eflag, cvalue, dvalue, fvalue, lvalue);
